...
pay_day = Attack("Pay Day", "physical", 40, "normal", 20, 32, payday = True)
...
swords_dance = Attack("Swords Dance", "status", 0, "normal", 20, 32, contact = False, modify_percent = 100, modify_list = [2, 0, 0, 0, 0], accuracy = 0)
...
poison_powder = Attack("Poison Powder", "status", 0, "poison", 35, 54, contact = False, accuracy = 75, status = "poisoned", stat_percent = 100)
confide = Attack("Confide", "status", 0, "normal", 20, 32, modify_list = [0, 0, -1, 0, 0], modify_target = "enemy", contact = False)

will_o_wisp = Attack("Will-O-Wisp", "status", 0, "fire", 15, 24, status = "burned", accuracy = 85, stat_percent = 100)
toxic = Attack("Toxic", "status", 0, "poison", 10, 16, status = "badly poisoned", accuracy = 90, stat_percent = 100)
dragon_dance = Attack("Dragon Dance", "status", 0, "dragon", 20, 32, modify_list = [1, 0, 0, 0, 1], modify_target = "user", modify_percent = 100, accuracy = 0)
