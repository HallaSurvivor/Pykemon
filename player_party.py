...
Jessica = generator.generate("bulbasaur", [move_list.swords_dance, move_list.giga_impact, move_list.bind, move_list.absorb], "player")
...
Jason = generator.generate("mudkip", [move_list.vice_grip, move_list.ice_punch, move_list.fire_punch, move_list.guillotine], "player")
Jason.name = "Jason"

Cameron = generator.generate("ivysaur", [move_list.growl, move_list.tackle, move_list.bite], "player")
Cameron.name = "Cameron"

player_party = [Cameron, Jason, Creighton, Jessica, Mary]
